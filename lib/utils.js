...
var OPTIONS_KEYS = ['api_key', 'idempotency_key', /* 'stripe_account', */'mailchimp_version'];
  ...
  getOptionsFromArgs: function(args) {
    ...
    if (args.length > 0) {
      ...
      if (utils.isAuthKey(arg)) {
        ...
        // }
        if (params.mailchimp_version) {
          opts.headers['Mailchimp-Version'] = params.mailchimp_version;
        }
      }
    }
    return opts;
