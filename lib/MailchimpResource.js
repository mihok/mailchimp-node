...
MailchimpResource.prototype = {
  ...
  _responseHandler: function(req, callback) {
    ...
    return function(res) {
      ...
      res.on('end', function() {
        ...
        // console.log('RAW RESPONSE', response, res.statusCode); // eslint-disable-line no-console
        try {
  ...
  _request: function(method, path, data, auth, options, callback) {
    ...
    function makeRequest() {
      ...
      console.log('PATH', host, path, method); // eslint-disable-line no-console
      var req = (
      ...
      req.on('socket', function(socket) {
        socket.on((isInsecureConnection ? 'connect' : 'secureConnect'), function() {
          ...
          console.log('DATA', requestData); // eslint-disable-line no-console
